...
fun calcularNota(nombrePrueba: String, resultado: Float, edad: Int, genero: String): String {
    println("Recibido en calcularNota -> Prueba: $nombrePrueba, Resultado: $resultado, Edad: $edad, Género: $genero")

    return when (nombrePrueba.trim()) {
        ...
        "Lanzamiento Balón" -> calcularNotaLanzamiento(resultado, edad, genero)
        else -> {
            println("Nombre de prueba no reconocido: $nombrePrueba")
            "0"
        }
    }
}
